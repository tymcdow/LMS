...
PreparedStatement pst;
    ...
    public void Delete(){
        String sql="delete from Issue where Member_ID=?";
        try{
    ...
    public void ReturnUpdate(){
        String sql="Insert into Return(Member_ID,Name,FName,Branch,Year,Book_ID,BName,Edition,Publisher,Price,Pages,DOI,DOR) Values (?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
        pst=con.prepareStatement(sql);
        pst.setString(1, jTextField1.getText());
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 204, 255), 6), "Return Panel", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 24), new java.awt.Color(0, 204, 255))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon("C:\\Users\\ohiob\\Downloads\\search_button.png")); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\ohiob\\Downloads\\books_stack.png")); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String sql="select * from Issue where Member_ID=?";
        try{
            pst=con.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
            rs=pst.executeQuery();
